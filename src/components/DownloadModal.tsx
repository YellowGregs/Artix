        ...
        >
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-gray-400">You're about to download the latest version of Falcon Executor</p>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <motion.button
                ...
                className="flex-1 px-4 py-2 rounded-xl bg-blue-500/20 text-blue-400 hover:bg-blue-500/30 border border-blue-500/30 transition-all duration-200"
              >
                Download
              </motion.button>
            </div>
